...
Cylinder::Cylinder(
    ...
    makeCylinderDiameter(cap, diameter, count, color, transformations);
};
...
void Cylinder::makeCylinderDiameter(
        bool cap,
        float diameter,
        int count,
        glm::vec3 color,
    ...
    for (size_t i = 0; i < count; i++) {
        ...
        vertices.emplace_back(glm::vec3(0.f, prevY, prevZ));
        vertices.emplace_back(glm::vec3(0.f, y, z));
        vertices.emplace_back(glm::vec3(1.f, prevY/diameter, prevZ/diameter));
        ...
        vertices.emplace_back(glm::vec3(0.f, y, z));
        vertices.emplace_back(glm::vec3(1.f, y/diameter, z/diameter));
        vertices.emplace_back(glm::vec3(1.f, prevY/diameter, prevZ/diameter));
